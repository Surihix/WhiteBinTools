...
namespace WhiteBinTools.Repack
{
    ...
    {
        public static void RepackSingle(GameCode gameCode, string filelistFile, string whiteBinFile, string whiteFilePath, StreamWriter logWriter)
        {
            ...
            SharedFunctions.CheckFileExists(outFile, logWriter, "Error: Specified file to repack in the argument is missing");
