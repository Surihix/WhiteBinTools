...
using static WhiteBinTools.SupportClasses.CmnEnums;

namespace WhiteBinTools
{
    internal class UnpackTypeTest
    {
        public static void UnpackFilelistTest(CmnEnums.GameCodes gameCodeVar, string filelistFileVar, StreamWriter logWriter)
        {
