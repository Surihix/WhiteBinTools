...
namespace WhiteBinTools.RepackClasses
{
    ...
    {
        public static void RepackSingle(CmnEnums.GameCodes gameCodeVar, string filelistFileVar, string whiteBinFileVar, string whiteFilePathVar, StreamWriter logWriter)
        {
